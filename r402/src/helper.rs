//! Shared utility types for the x402 protocol.
//!
//! This module provides small, commonly-used types that don't belong to a
//! specific protocol layer:
//!
//! - [`Base64Bytes`] — base64-encoded byte wrapper
//! - [`UnixTimestamp`] — Unix epoch seconds with string serialization
