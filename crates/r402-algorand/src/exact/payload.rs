//! Wire payload types for the Algorand `"exact"` payment scheme.
//!
...
pub mod v2 {
    ...
    pub type PaymentPayload = WirePayload<PaymentRequirements, ExactAvmPayload>;

    /// Type alias for payment requirements with Algorand-specific types.
    pub type PaymentRequirements = WireReqs<ExactScheme, U64String, CompactString, AlgorandExtra>;
}
