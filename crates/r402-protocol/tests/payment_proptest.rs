...
//! Property-based payment-envelope round-trip tests.
...
use r402_protocol::{ChainId, ErrorReason};
...
fn arb_error_reason() -> impl Strategy<Value = ErrorReason> {
    prop_oneof![
        ...
        Just(ErrorReason::IncompatibleSettlementMode),
        Just(ErrorReason::SettlementAborted),
