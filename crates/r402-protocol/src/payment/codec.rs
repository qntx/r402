//! JSON-safe primitives used by x402 payment envelopes.
...
impl<const N: u8> Version<N> {
    /// Numeric value of this version marker.
...
///
/// Encoding is eager; decoding is deferred.
///
/// # Examples
///
/// ```
...
impl Base64Bytes {
    /// Decodes the inner base64 bytes into raw binary.
    ///
    /// # Errors
    ///
    /// Returns a [`base64::DecodeError`] when the stored bytes are not valid
    /// base64.
...
///
/// Serializes as a JSON string; deserializes from a string or number.
///
/// # Examples
///
/// ```
...
impl UnixTimestamp {
    ...
    /// Current system clock as a [`UnixTimestamp`].
    ///
