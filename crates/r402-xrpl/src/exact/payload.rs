...
pub mod v2 {
    ...
    pub type PaymentPayload = payment::PaymentPayload<PaymentRequirements, ExactXrplPayload>;

    /// Type alias for payment requirements with XRPL-specific types.
    pub type PaymentRequirements =
        payment::PaymentRequirements<ExactScheme, XrplTokenAmount, XrplAddress, XrplExtra>;
}
...
mod tests {
    ...
    fn golden_requirements_fixture_roundtrips() {
        let raw = include_str!("../../../../tests/fixtures/xrpl/ts_payment_requirements.json");
