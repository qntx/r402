...
use crate::chain::{AlgorandAddress, AlgorandChainReference, normalize_algorand_network};
use crate::exact::{AlgorandExact, DEFAULT_VALIDITY_ROUNDS, ExactAvmPayload, payload};
    ...
    R: AlgodRpc,
{
    fn sign_payment(
        ...
        Box::pin(async move {
            ...
            .await?;
            let payload = payload::v2::PaymentPayload::new(self.requirements.clone(), payload)
