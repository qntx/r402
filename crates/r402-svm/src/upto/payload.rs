//! Wire payload types for the Solana `upto` payment-channel scheme.

pub use r402_protocol::UptoScheme;
...
/// JSON key attached by the server scheme on claim/cancel settle.
...
pub mod v2 {
    ...
    pub type PaymentPayload = WirePayload<PaymentRequirements, UptoSvmPayload>;
    /// Payment requirements with Solana address types.
    pub type PaymentRequirements = WireReqs<UptoScheme, U64String, Address, serde_json::Value>;
}
