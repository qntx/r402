//! NEAR addresses, chain references, and NEP-141 deployments.
...
/// Circle USDC NEP-141 account on NEAR mainnet (implicit account).
pub const USDC_MAINNET_ACCOUNT: &str =
    "17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1";

/// Circle USDC NEP-141 account on NEAR testnet (implicit account).
pub const USDC_TESTNET_ACCOUNT: &str =
