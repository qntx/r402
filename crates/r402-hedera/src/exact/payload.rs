...
pub mod v2 {
    ...
    pub type PaymentPayload = payment::PaymentPayload<PaymentRequirements, ExactHederaPayload>;

    /// Type alias for payment requirements with Hedera-specific types.
    pub type PaymentRequirements =
        payment::PaymentRequirements<ExactScheme, HederaTokenAmount, HederaAddress, HederaExtra>;
}
...
mod tests {
    ...
    fn extra_golden_fixture_roundtrips() {
        let raw = include_str!("../../../../tests/fixtures/hedera/extra.json");
