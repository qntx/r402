//! Wire payload types for the Solana exact payment scheme.
//!
...
pub use r402_protocol::ExactScheme;
...
/// Wire format type aliases for Solana exact scheme.
///
...
pub mod v2 {
    ...
    pub type PaymentPayload = WirePayload<PaymentRequirements, ExactSolanaPayload>;

    /// Type alias for payment requirements with Solana-specific types.
    pub type PaymentRequirements =
        WireReqs<ExactScheme, U64String, Address, SupportedPaymentKindExtra>;
}
