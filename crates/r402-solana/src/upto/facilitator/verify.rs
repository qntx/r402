...
use r402_core::wire::{Base64Bytes, SettleResponse, VerifyResponse};
...
use crate::upto::payment_channels::{VerifyOpenExpected, verify_open_transaction};
use crate::upto::shared::{
    PaymentChannelConfig, parse_extra_memo, resolve_payment_channel_config, resolve_token_program,
};
use crate::upto::types::{UptoScheme, UptoSvmPayload};
...
pub struct OpenAuth {
    ...
    pub(crate) channel: PaymentChannelConfig,
    /// Authorized ceiling.
    pub max_amount: u64,
    /// Token program.
...
impl UptoFailure {
    ...
    pub fn into_settle(self, network: impl Into<compact_str::CompactString>) -> SettleResponse {
        SettleResponse::Failure {
            ...
            extensions: r402_core::wire::Extensions::new(),
            extra: None,
        }
    }
...
pub fn validate_open_authorization<P: SolanaChainProviderLike>(
    ...
    requirements: &r402_core::wire::PaymentRequirements,
    accepted_scheme: &str,
