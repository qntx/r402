...
use super::payment_channels::{BuildOpenArgs, build_open_transaction};
use super::shared::{
    parse_extra_memo, parse_extra_u64, parse_token_program_hint, resolve_payment_channel_config,
};
use super::types::{UptoSvmPayload, extra_keys, v2};
...
impl<S, R> Sealed for SolanaUptoClient<S, R> {}
...
fn untyped_requirements(
    requirements: &v2::PaymentRequirements,
) -> r402_core::wire::PaymentRequirements {
    r402_core::wire::PaymentRequirements::new(
...
mod tests {
    use super::*;
    use crate::upto::types::ASSET_TRANSFER_METHOD_CHANNEL;

    #[test]
    fn client_scheme_id_is_upto() {
        // Type-level check: namespace/scheme match the marker.
