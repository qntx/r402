...
use r402_core::error::{ErrorReason, FacilitatorError, VerificationError};

use super::shared::SharedError;
...
impl From<SharedError> for VerificationError {
    fn from(err: SharedError) -> Self {
        Self::InvalidFormat(err.to_string())
    }
}

impl From<SharedError> for FacilitatorError {
    fn from(err: SharedError) -> Self {
