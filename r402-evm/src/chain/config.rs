...
///
/// ```ignore
/// use r402_evm::chain::{Eip155ChainConfig, Eip155ChainReference};
///
...
impl Eip155ChainConfig {
    ...
    #[must_use]
    pub const fn flashblocks(&self) -> bool {
    ...
    #[must_use]
    pub const fn signers(&self) -> &Eip155SignersConfig {
        &self.inner.signers
    }

    /// Returns the RPC endpoint configurations for this chain.
    #[must_use]
    pub const fn rpc(&self) -> &Vec<RpcConfig> {
        &self.inner.rpc
    }

    /// Returns the numeric chain reference.
    #[must_use]
    pub const fn chain_reference(&self) -> Eip155ChainReference {
...
mod eip155_chain_config {
    pub const fn default_eip1559() -> bool {
        true
    }
    pub const fn default_flashblocks() -> bool {
        false
    }
    pub const fn default_receipt_timeout_secs() -> u64 {
        30
    }
}
