...
impl KnownNetworkEip155<Self> for ChainId {
    ...
    fn ethereum_sepolia() -> Self {
        Self::new("eip155", "11155111")
    }
    fn base() -> Self {
        Self::new("eip155", "8453")
    }
    fn base_sepolia() -> Self {
        Self::new("eip155", "84532")
    }
    fn arbitrum() -> Self {
        Self::new("eip155", "42161")
    }
    fn arbitrum_sepolia() -> Self {
        Self::new("eip155", "421614")
    }
    fn optimism() -> Self {
        Self::new("eip155", "10")
    }
    fn optimism_sepolia() -> Self {
        Self::new("eip155", "11155420")
    }
    fn polygon() -> Self {
        Self::new("eip155", "137")
    }
    fn polygon_amoy() -> Self {
        Self::new("eip155", "80002")
    }
    fn avalanche() -> Self {
        Self::new("eip155", "43114")
    }
    fn avalanche_fuji() -> Self {
        Self::new("eip155", "43113")
    }
    fn celo() -> Self {
        Self::new("eip155", "42220")
    }
    fn celo_sepolia() -> Self {
        Self::new("eip155", "11142220")
    }
    fn sei() -> Self {
        Self::new("eip155", "1329")
    }
    fn sei_testnet() -> Self {
        Self::new("eip155", "1328")
    }
    fn sonic() -> Self {
        Self::new("eip155", "146")
    }
    fn sonic_blaze() -> Self {
        Self::new("eip155", "57054")
    }
    fn unichain() -> Self {
        Self::new("eip155", "130")
    }
    fn unichain_sepolia() -> Self {
        Self::new("eip155", "1301")
    }
    fn world_chain() -> Self {
        Self::new("eip155", "480")
    }
    fn world_chain_sepolia() -> Self {
        Self::new("eip155", "4801")
    }
    fn zksync() -> Self {
        Self::new("eip155", "324")
    }
    fn zksync_sepolia() -> Self {
        Self::new("eip155", "300")
    }
    fn linea() -> Self {
        Self::new("eip155", "59144")
    }
    fn linea_sepolia() -> Self {
        Self::new("eip155", "59141")
    }
    fn ink() -> Self {
        Self::new("eip155", "57073")
    }
    fn ink_sepolia() -> Self {
        Self::new("eip155", "763373")
    }
    fn hyperevm() -> Self {
        Self::new("eip155", "999")
    }
    fn hyperevm_testnet() -> Self {
        Self::new("eip155", "998")
    }
    fn monad() -> Self {
        Self::new("eip155", "143")
    ...
    fn monad_testnet() -> Self {
        Self::new("eip155", "10143")
    }
    fn plume() -> Self {
        Self::new("eip155", "98866")
    }
    fn plume_testnet() -> Self {
        Self::new("eip155", "98867")
    }
    fn codex() -> Self {
        Self::new("eip155", "81224")
    }
    fn codex_testnet() -> Self {
        Self::new("eip155", "812242")
    }
    fn xdc() -> Self {
        Self::new("eip155", "50")
    }
    ...
    fn xrpl_evm() -> Self {
        Self::new("eip155", "1440000")
    }
    fn peaq() -> Self {
        Self::new("eip155", "3338")
    }
    fn iotex() -> Self {
...
impl KnownNetworkEip155<Eip155TokenDeployment> for USDC {
    ...
    fn sonic() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn sonic_blaze() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn unichain() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn unichain_sepolia() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn world_chain() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn world_chain_sepolia() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn zksync() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn zksync_sepolia() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn linea() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn linea_sepolia() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn ink_sepolia() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn hyperevm() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn hyperevm_testnet() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn monad() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn monad_testnet() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn plume() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn plume_testnet() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn codex() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn codex_testnet() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
    ...
    fn xdc_apothem() -> Eip155TokenDeployment {
        Eip155TokenDeployment {
