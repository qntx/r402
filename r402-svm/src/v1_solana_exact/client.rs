...
//!
//! ```rust
//! use r402_svm::v1_solana_exact::client::V1SolanaExactClient;
...
#[allow(dead_code, missing_debug_implementations)] // Public for consumption by downstream crates.
/// Signs Solana payment payloads for the V1 exact scheme.
